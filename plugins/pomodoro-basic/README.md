...
- Optional floating widget (desktop/tablet) and a phone tray chip + bottom sheet, all on one shared countdown
...
The countdown keeps true time even while the app sits in the background: a
25-minute block ends 25 minutes after it started, wherever you were looking.

If you decline system notifications, the chime and the on-screen display still
work.
