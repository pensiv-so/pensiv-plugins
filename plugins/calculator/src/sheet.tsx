 ...
 * phone there is no room to dock a pane beside the editor, so the tray is where
 * a tool like this lives.
 *
 ...
 */
export const CalculatorSheet: React.FC<WidgetProps> = ({ app }) => (
  <SheetStack>
    <SheetGroup style={{ padding: '0.625rem' }}>
