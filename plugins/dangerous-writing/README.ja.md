...
**デンジャラス・ライティング（Dangerous Writing）** は、白紙のページを緊張感あふれるスプリントに変えます。開いているドキュメントを「武装」して、タイピングし続けてください。長く止まった瞬間、導火線が燃え始め — ゼロに達すると、それまでに書いたすべてが消去されます。取り消しはありません。

内なる編集者を黙らせる最も確実な方法です。自分の文章を消すという選択肢がなくなり — むしろ *止まること* が文章を消してしまうから — 自己検閲をやめて、ただ書くようになります。
...
- **導火線の調整** — 消去までに止まっていられる時間を設定（3〜10秒）
- **ハードコアモード** — より短い導火線と、ほとんど無い警告
- **全画面の緊張感** — 導火線が燃えるにつれて画面が赤く染まります
