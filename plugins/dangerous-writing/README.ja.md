...
**デンジャラス・ライティング（Dangerous Writing）** は、白紙のページを緊張感あふれるスプリントに変えます。開いているドキュメントを「武装」して、タイピングし続けてください。長く止まった瞬間、導火線が燃え始め、ゼロに達するとそれまでに書いたすべてが消去されます。取り消しはありません。

内なる編集者を黙らせる最も確実な方法です。自分の文章を消すという選択肢がなくなり、むしろ *止まること* が文章を消してしまうから、自己検閲をやめてただ書くようになります。
...
- **クリップボードのロック**：セッション中のコピー＆ペーストを禁止 — 燃えるかもしれない原稿を先にコピーして退避することも、自分で書いていない文章で目標を埋めることもできません。両方禁止（既定）、貼り付けのみ禁止、両方許可から選べます
