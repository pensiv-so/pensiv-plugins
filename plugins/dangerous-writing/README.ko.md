...
**위험한 글쓰기(Dangerous Writing)** 는 백지를 긴장감 넘치는 스프린트로 바꿉니다. 열려 있는 문서를 "무장"한 뒤 계속 타이핑하세요. 너무 오래 멈추면 도화선이 타들어가고, 0에 도달하는 순간 지금까지 쓴 모든 것이 지워집니다. 되돌리기는 없습니다.

머릿속 편집자를 잠재우는 가장 확실한 방법입니다. 내가 쓴 문장을 지우는 선택지가 사라지고, 오히려 *멈추는 것* 이 문장을 지우기 때문에 자기검열을 멈추고 그냥 쓰게 됩니다.
...
### 기능
- **두 가지 목표**: 타이머를 버티거나 목표 단어 수를 채웁니다
- **도화선 조절**: 지워지기까지 멈출 수 있는 시간을 설정합니다 (3~10초)
- **하드코어 모드**: 도화선이 더 짧아지고 경고도 거의 없습니다
- **클립보드 잠금**: 세션 동안 복사·붙여넣기를 막습니다 — 불탈지 모르는 글을 미리 복사해 백업할 수 없고, 직접 쓰지 않은 글로 단어 목표를 채울 수도 없습니다. 둘 다 차단(기본값), 붙여넣기만 차단, 모두 허용 중에서 고르세요
- **전체 화면 긴장감**: 도화선이 타들어갈수록 화면이 붉게 물듭니다
